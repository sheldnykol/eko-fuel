<footer class="bg-[#1a1a1a] py-12 text-white">
    <div class="container mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-10 md:grid-cols-3">
            <!-- Στήλη 1: Λογότυπο + σύντομη περιγραφή -->
            <div>
                <div class="mb-6 flex items-center">
                    <img src="{{ asset('images/eko-logo.png') }}" alt="EKO Logo" class="mr-4 h-12 w-auto" />
                    <h3 class="text-2xl font-bold">EKO Fuel</h3>
                </div>
                <p class="mt-2 text-lg text-shadow-indigo-50">Τηλ: 2410283954 | EKO -AΦΟΙ Κ ΔΡΑΜΗ ΟΕ </p>
                <br/>
                <p class="text-sm leading-relaxed text-gray-400">
                    Τα  πρατήρια EKO σου προσφέρουν ποιοτικά καύσιμα, προϊόντα και υπηρεσίες πλυντηρίου αυτοκινήτου.
                    Βρες μας εύκολα και κλείσε άμεσα!
                </p>
                
                <p class="mt-4 text-sm text-gray-500">
                    &copy; {{ date('Y') }} EKO Fuel. Όλα τα δικαιώματα διατηρούνται.
                </p>
            </div>

            <!-- Στήλη 2: Γρήγοροι σύνδεσμοι -->
            <div>
