        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:gap-16">
               ...
               class="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-slate-200 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                <div class="relative h-64 overflow-hidden md:h-80">
                    ...
                    <div class="absolute top-6 right-6">
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-white/90 px-3 py-1 text-xs font-bold text-emerald-600 backdrop-blur-sm">
                            <span class="h-2 w-2 animate-pulse rounded-full bg-emerald-500"></span> ΑΝΟΙΧΤΟ
                        </span>
                    </div>
                </div>
                <div class="flex flex-1 flex-col p-8">
                    <div class="mb-3 flex items-center gap-2 text-xs font-bold tracking-widest text-red-600 uppercase">
                        <span>Πρατήριο 01</span><span class="h-px w-8 bg-red-200"></span>
                    </div>
                    <h3 class="mb-4 text-2xl leading-tight font-black text-slate-900 transition-colors group-hover:text-red-600 md:text-3xl">
                        ΒΟΛΟΥ 12, ΛΑΡΙΣΑ
                    </h3>
                    <p class="mb-8 leading-relaxed text-slate-500">
                        Στο κεντρικότερο σημείο της οδού Βόλου, προσφέρουμε κορυφαία καύσιμα και ολοκληρωμένες υπηρεσίες πλυντηρίου.
                    </p>
                    <div class="mt-auto flex items-center justify-between border-t border-slate-100 pt-6">
                        ...
                        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-red-600 transition-all group-hover:rotate-45 group-hover:bg-red-600 group-hover:text-white">
            ...
            <a href="{{ route('station.show', 2) }}" 
               class="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-slate-200 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div class="flex flex-1 flex-col p-8">
                    <div class="mb-3 flex items-center gap-2 text-xs font-bold tracking-widest text-red-600 uppercase">
                        <span>Πρατήριο 02</span><span class="h-px w-8 bg-red-200"></span>
                    </div>
                    <h3 class="mb-4 text-2xl leading-tight font-black text-slate-900 transition-colors group-hover:text-red-600 md:text-3xl">
            ...
            <a href="{{ route('station.show', 3) }}" 
               class="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-slate-200 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div class="flex flex-1 flex-col p-8">
                    <div class="mb-3 flex items-center gap-2 text-xs font-bold tracking-widest text-red-600 uppercase">
                        <span>Πρατήριο 03</span><span class="h-px w-8 bg-red-200"></span>
                    </div>
                    <h3 class="mb-4 text-2xl leading-tight font-black text-slate-900 transition-colors group-hover:text-red-600 md:text-3xl">
            ...
            <a href="{{ route('station.show', 4) }}" 
               class="group relative flex flex-col overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-slate-200 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div class="flex flex-1 flex-col p-8">
                    <div class="mb-3 flex items-center gap-2 text-xs font-bold tracking-widest text-red-600 uppercase">
                        <span>Πρατήριο 04</span><span class="h-px w-8 bg-red-200"></span>
                    </div>
                    <h3 class="mb-4 text-2xl leading-tight font-black text-slate-900 transition-colors group-hover:text-red-600 md:text-3xl">
                        11ο ΧΛΜ, ΕΟ ΒΟΛΟΥ ΠΟΡΤΑΡΙΑΣ
                    </h3>
                    <p class="mb-8 leading-relaxed text-slate-500">
                        Στην καρδιά του Πηλείου, το σημείο αναφοράς για τον καθημερινό ανεφοδιασμό των κατοίκων της γύρω περιοχής.
                    </p>
                    <div class="mt-auto flex items-center justify-between border-t border-slate-100 pt-6">
                        <span class="text-sm font-bold text-slate-900">Δες Τιμές Καυσίμων & Υπηρεσίες</span>
                        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-red-600 transition-all group-hover:rotate-45 group-hover:bg-red-600 group-hover:text-white">
