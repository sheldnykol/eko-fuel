<section class="bg-slate-50 py-18 md:py-24">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
            ...
            <a href="{{ route('heating-oil-orders.create') }}" class="group relative block w-full max-w-sm p-10 bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-2xl hover:border-orange-500 transition-all duration-300 text-center">
